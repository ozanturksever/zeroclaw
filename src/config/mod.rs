...
pub use schema::{
    ...
    EmbeddingRouteConfig, EstopConfig, GatewayConfig, HardwareConfig, HardwareTransport,
    ...
    ObservabilityConfig, OossInstanceIdentity, OtpConfig, OtpMethod, PeripheralBoardConfig,
    PeripheralsConfig, ProxyConfig, ProxyScope,
